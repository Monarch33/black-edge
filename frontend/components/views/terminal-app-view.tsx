        ...
        {!isConnected && (
          <section className="min-h-[80vh] flex items-center justify-center px-6 pt-24 pb-16">
            <div className="max-w-[900px] mx-auto text-center">
              ...
              <h1 className="font-bold text-[clamp(42px,7vw,90px)] leading-[0.95] tracking-[-0.04em] mb-6">
          ...
          <section className="min-h-screen pt-24 pb-16 px-6">
            <div className="max-w-[1200px] mx-auto">
              <div className="mb-10">
                ...
                <h2 className="text-[clamp(28px,4vw,48px)] font-bold tracking-[-0.03em] leading-tight">
                  Positions ouvertes
                  <br />
