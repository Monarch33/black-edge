          ...
          <div className="section-inner">
            ...
            <div className="auth-grid">
              ...
              <div className="auth-panel reveal reveal-delay-3">
                ...
                <div className="auth-divider">OR JOIN THE WAITLIST</div>
                      ...
                      try {
                        ...
                        if (res.ok) {
                          ...
                          if (data.status === "already_registered") {
                            toast.info(`You're already on the list! Position #${data.queue_position}`)
                          } else {
                            toast.success(`You're #${data.queue_position} on the waitlist — check your inbox`)
                          }
                          setAuthEmail("")
                        } else {
                ...
                <div style={{ fontSize: 8, letterSpacing: ".12em", color: "rgba(255,255,255,.15)", textAlign: "center", marginTop: 4 }}>
                  By signing up you agree to our <a href="/terms" style={{ textDecoration: "underline" }}>Terms of Service</a> and <a href="/privacy" style={{ textDecoration: "underline" }}>Privacy Policy</a>
                </div>
              </div>
            </div>
          </div>
